    ...
    <div className="min-h-screen w-full flex items-center justify-center">
      <Card className="w-[380px] px-5">
        <CardHeader className="text-center">
          ...
          <CardDescription>We have sent a verification link to your email <address className=""></address></CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter>
            <Link href="/" className={buttonVariants({
                className:'w-full',
                variant:'outline'
            })}><ArrowLeft className="size-4 mr-2"/>Back to homepage</Link>
